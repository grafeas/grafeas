...
|INTOTO|An in-toto step|Details of a particular in-toto link attestation of the corresponding step. The in-toto specification is available [here](https://github.com/in-toto/docs/blob/master/in-toto-spec.md)|
