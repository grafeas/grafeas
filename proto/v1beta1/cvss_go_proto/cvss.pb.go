...
const (
	CVSSv2_ATTACK_VECTOR_UNSPECIFIED CVSSv2_AttackVector = 0
	CVSSv2_ATTACK_VECTOR_LOCAL       CVSSv2_AttackVector = 1
	CVSSv2_ATTACK_VECTOR_ADJACENT    CVSSv2_AttackVector = 2
	CVSSv2_ATTACK_VECTOR_NETWORK     CVSSv2_AttackVector = 3
)
...
var (
	CVSSv2_AttackVector_name = map[int32]string{
		0: "ATTACK_VECTOR_UNSPECIFIED",
		1: "ATTACK_VECTOR_LOCAL",
		2: "ATTACK_VECTOR_ADJACENT",
		3: "ATTACK_VECTOR_NETWORK",
	}
	CVSSv2_AttackVector_value = map[string]int32{
		"ATTACK_VECTOR_UNSPECIFIED": 0,
		"ATTACK_VECTOR_LOCAL":       1,
		"ATTACK_VECTOR_ADJACENT":    2,
		"ATTACK_VECTOR_NETWORK":     3,
	}
)
...
func (CVSSv2_AttackVector) EnumDescriptor() ([]byte, []int) {
	return file_cvss_proto_rawDescGZIP(), []int{1, 0}
}

type CVSSv2_AttackComplexity int32

const (
	CVSSv2_ATTACK_COMPLEXITY_UNSPECIFIED CVSSv2_AttackComplexity = 0
	CVSSv2_ATTACK_COMPLEXITY_HIGH        CVSSv2_AttackComplexity = 1
	CVSSv2_ATTACK_COMPLEXITY_MEDIUM      CVSSv2_AttackComplexity = 2
	CVSSv2_ATTACK_COMPLEXITY_LOW         CVSSv2_AttackComplexity = 3
)

// Enum value maps for CVSSv2_AttackComplexity.
var (
	CVSSv2_AttackComplexity_name = map[int32]string{
		0: "ATTACK_COMPLEXITY_UNSPECIFIED",
		1: "ATTACK_COMPLEXITY_HIGH",
		2: "ATTACK_COMPLEXITY_MEDIUM",
		3: "ATTACK_COMPLEXITY_LOW",
	}
	CVSSv2_AttackComplexity_value = map[string]int32{
		"ATTACK_COMPLEXITY_UNSPECIFIED": 0,
		"ATTACK_COMPLEXITY_HIGH":        1,
		"ATTACK_COMPLEXITY_MEDIUM":      2,
		"ATTACK_COMPLEXITY_LOW":         3,
	}
)

func (x CVSSv2_AttackComplexity) Enum() *CVSSv2_AttackComplexity {
	p := new(CVSSv2_AttackComplexity)
	*p = x
	return p
}

func (x CVSSv2_AttackComplexity) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CVSSv2_AttackComplexity) Descriptor() protoreflect.EnumDescriptor {
	return file_cvss_proto_enumTypes[7].Descriptor()
}

func (CVSSv2_AttackComplexity) Type() protoreflect.EnumType {
	return &file_cvss_proto_enumTypes[7]
}

func (x CVSSv2_AttackComplexity) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CVSSv2_AttackComplexity.Descriptor instead.
func (CVSSv2_AttackComplexity) EnumDescriptor() ([]byte, []int) {
	return file_cvss_proto_rawDescGZIP(), []int{1, 1}
}

type CVSSv2_Authentication int32

const (
	CVSSv2_AUTHENTICATION_UNSPECIFIED CVSSv2_Authentication = 0
	CVSSv2_AUTHENTICATION_MULTIPLE    CVSSv2_Authentication = 1
	CVSSv2_AUTHENTICATION_SINGLE      CVSSv2_Authentication = 2
	CVSSv2_AUTHENTICATION_NONE        CVSSv2_Authentication = 3
)
...
func (CVSSv2_Authentication) EnumDescriptor() ([]byte, []int) {
	return file_cvss_proto_rawDescGZIP(), []int{1, 2}
}

type CVSSv2_Impact int32

const (
	CVSSv2_IMPACT_UNSPECIFIED CVSSv2_Impact = 0
	CVSSv2_IMPACT_NONE        CVSSv2_Impact = 1
	CVSSv2_IMPACT_PARTIAL     CVSSv2_Impact = 2
	CVSSv2_IMPACT_COMPLETE    CVSSv2_Impact = 3
)
...
func (CVSSv2_Impact) EnumDescriptor() ([]byte, []int) {
	return file_cvss_proto_rawDescGZIP(), []int{1, 3}
}
...
// For details, see https://www.first.org/cvss/v2/guide
...
type CVSSv2 struct {
	...
	AttackVector          CVSSv2_AttackVector     `protobuf:"varint,4,opt,name=attack_vector,json=attackVector,proto3,enum=grafeas.v1beta1.vulnerability.CVSSv2_AttackVector" json:"attack_vector,omitempty"`
	AttackComplexity      CVSSv2_AttackComplexity `protobuf:"varint,5,opt,name=attack_complexity,json=attackComplexity,proto3,enum=grafeas.v1beta1.vulnerability.CVSSv2_AttackComplexity" json:"attack_complexity,omitempty"`
	Authentication        CVSSv2_Authentication   `protobuf:"varint,6,opt,name=authentication,proto3,enum=grafeas.v1beta1.vulnerability.CVSSv2_Authentication" json:"authentication,omitempty"`
	ConfidentialityImpact CVSSv2_Impact           `protobuf:"varint,7,opt,name=confidentiality_impact,json=confidentialityImpact,proto3,enum=grafeas.v1beta1.vulnerability.CVSSv2_Impact" json:"confidentiality_impact,omitempty"`
	IntegrityImpact       CVSSv2_Impact           `protobuf:"varint,8,opt,name=integrity_impact,json=integrityImpact,proto3,enum=grafeas.v1beta1.vulnerability.CVSSv2_Impact" json:"integrity_impact,omitempty"`
	AvailabilityImpact    CVSSv2_Impact           `protobuf:"varint,9,opt,name=availability_impact,json=availabilityImpact,proto3,enum=grafeas.v1beta1.vulnerability.CVSSv2_Impact" json:"availability_impact,omitempty"`
}

func (x *CVSSv2) Reset() {
	*x = CVSSv2{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cvss_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CVSSv2) Descriptor() ([]byte, []int) {
	return file_cvss_proto_rawDescGZIP(), []int{1}
}

func (x *CVSSv2) GetBaseScore() float32 {
	if x != nil {
		return x.BaseScore
	}
	return 0
...
func (x *CVSSv2) GetAttackVector() CVSSv2_AttackVector {
	...
	return CVSSv2_ATTACK_VECTOR_UNSPECIFIED
}

func (x *CVSSv2) GetAttackComplexity() CVSSv2_AttackComplexity {
	if x != nil {
		return x.AttackComplexity
	}
	return CVSSv2_ATTACK_COMPLEXITY_UNSPECIFIED
}
...
func (x *CVSSv2) GetAuthentication() CVSSv2_Authentication {
	...
	return CVSSv2_AUTHENTICATION_UNSPECIFIED
}

func (x *CVSSv2) GetConfidentialityImpact() CVSSv2_Impact {
	if x != nil {
		return x.ConfidentialityImpact
	}
	return CVSSv2_IMPACT_UNSPECIFIED
}

func (x *CVSSv2) GetIntegrityImpact() CVSSv2_Impact {
	if x != nil {
		return x.IntegrityImpact
	}
	return CVSSv2_IMPACT_UNSPECIFIED
...
func (x *CVSSv2) GetAvailabilityImpact() CVSSv2_Impact {
	if x != nil {
		return x.AvailabilityImpact
	}
	return CVSSv2_IMPACT_UNSPECIFIED
...
var file_cvss_proto_rawDesc = []byte{
	...
	0x22, 0xa2, 0x09, 0x0a, 0x06, 0x43, 0x56, 0x53, 0x53, 0x76, 0x32, 0x12, 0x1d, 0x0a, 0x0a, 0x62,
	0x61, 0x73, 0x65, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x02, 0x52,
	0x09, 0x62, 0x61, 0x73, 0x65, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x31, 0x0a, 0x14, 0x65, 0x78,
	...
	,
	...
	,
	...
	,
	...
	0x45, 0x58, 0x49, 0x54, 0x59, 0x5f, 0x48, 0x49, 0x47, 0x48, 0x10, 0x01, 0x12, 0x1c, 0x0a, 0x18,
	0x41, 0x54, 0x54, 0x41, 0x43, 0x4b, 0x5f, 0x43, 0x4f, 0x4d, 0x50, 0x4c, 0x45, 0x58, 0x49, 0x54,
	0x59, 0x5f, 0x4d, 0x45, 0x44, 0x49, 0x55, 0x4d, 0x10, 0x02, 0x12, 0x19, 0x0a, 0x15, 0x41, 0x54,
	0x54, 0x41, 0x43, 0x4b, 0x5f, 0x43, 0x4f, 0x4d, 0x50, 0x4c, 0x45, 0x58, 0x49, 0x54, 0x59, 0x5f,
	0x4c, 0x4f, 0x57, 0x10, 0x03, 0x22, 0x81, 0x01, 0x0a, 0x0e, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e,
	...
	0x45, 0x4e, 0x54, 0x49, 0x43, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x4d, 0x55, 0x4c, 0x54, 0x49,
	0x50, 0x4c, 0x45, 0x10, 0x01, 0x12, 0x19, 0x0a, 0x15, 0x41, 0x55, 0x54, 0x48, 0x45, 0x4e, 0x54,
	0x49, 0x43, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x49, 0x4e, 0x47, 0x4c, 0x45, 0x10, 0x02,
	0x12, 0x17, 0x0a, 0x13, 0x41, 0x55, 0x54, 0x48, 0x45, 0x4e, 0x54, 0x49, 0x43, 0x41, 0x54, 0x49,
	0x4f, 0x4e, 0x5f, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x03, 0x22, 0x5a, 0x0a, 0x06, 0x49, 0x6d, 0x70,
	...
	0x4d, 0x50, 0x41, 0x43, 0x54, 0x5f, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x01, 0x12, 0x12, 0x0a, 0x0e,
	0x49, 0x4d, 0x50, 0x41, 0x43, 0x54, 0x5f, 0x50, 0x41, 0x52, 0x54, 0x49, 0x41, 0x4c, 0x10, 0x02,
	0x12, 0x13, 0x0a, 0x0f, 0x49, 0x4d, 0x50, 0x41, 0x43, 0x54, 0x5f, 0x43, 0x4f, 0x4d, 0x50, 0x4c,
	0x45, 0x54, 0x45, 0x10, 0x03, 0x42, 0x62, 0x0a, 0x20, 0x69, 0x6f, 0x2e, 0x67, 0x72, 0x61, 0x66,
	0x65, 0x61, 0x73, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x76, 0x75, 0x6c, 0x6e,
	0x65, 0x72, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x50, 0x01, 0x5a, 0x36, 0x67, 0x69, 0x74,
...
var file_cvss_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cvss_proto_goTypes = []interface{}{
	...
	(CVSSv2_AttackVector)(0),       // 6: grafeas.v1beta1.vulnerability.CVSSv2.AttackVector
	(CVSSv2_AttackComplexity)(0),   // 7: grafeas.v1beta1.vulnerability.CVSSv2.AttackComplexity
	(CVSSv2_Authentication)(0),     // 8: grafeas.v1beta1.vulnerability.CVSSv2.Authentication
	(CVSSv2_Impact)(0),             // 9: grafeas.v1beta1.vulnerability.CVSSv2.Impact
	(*CVSSv3)(nil),                 // 10: grafeas.v1beta1.vulnerability.CVSSv3
	(*CVSSv2)(nil),                 // 11: grafeas.v1beta1.vulnerability.CVSSv2
}
var file_cvss_proto_depIdxs = []int32{
	...
	6,  // 8: grafeas.v1beta1.vulnerability.CVSSv2.attack_vector:type_name -> grafeas.v1beta1.vulnerability.CVSSv2.AttackVector
	7,  // 9: grafeas.v1beta1.vulnerability.CVSSv2.attack_complexity:type_name -> grafeas.v1beta1.vulnerability.CVSSv2.AttackComplexity
	8,  // 10: grafeas.v1beta1.vulnerability.CVSSv2.authentication:type_name -> grafeas.v1beta1.vulnerability.CVSSv2.Authentication
	9,  // 11: grafeas.v1beta1.vulnerability.CVSSv2.confidentiality_impact:type_name -> grafeas.v1beta1.vulnerability.CVSSv2.Impact
	9,  // 12: grafeas.v1beta1.vulnerability.CVSSv2.integrity_impact:type_name -> grafeas.v1beta1.vulnerability.CVSSv2.Impact
	9,  // 13: grafeas.v1beta1.vulnerability.CVSSv2.availability_impact:type_name -> grafeas.v1beta1.vulnerability.CVSSv2.Impact
...
func file_cvss_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cvss_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CVSSv2); i {
			case 0:
				return &v.state
			case 1:
