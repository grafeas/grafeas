...
func (CVSS_AttackRequirements) Descriptor() protoreflect.EnumDescriptor {
	return file_cvss_proto_enumTypes[8].Descriptor()
}

func (CVSS_AttackRequirements) Type() protoreflect.EnumType {
	return &file_cvss_proto_enumTypes[8]
}
...
func (CVSS_AttackRequirements) EnumDescriptor() ([]byte, []int) {
	return file_cvss_proto_rawDescGZIP(), []int{0, 7}
}
...
func (CVSS_ExploitMaturity) Descriptor() protoreflect.EnumDescriptor {
	return file_cvss_proto_enumTypes[9].Descriptor()
}

func (CVSS_ExploitMaturity) Type() protoreflect.EnumType {
	return &file_cvss_proto_enumTypes[9]
}
...
func (CVSS_ExploitMaturity) EnumDescriptor() ([]byte, []int) {
	return file_cvss_proto_rawDescGZIP(), []int{0, 8}
}

// Common Vulnerability Scoring System.
// This message is compatible with CVSS v2, v3, and v4.
...
// For CVSS v4 details, see https://www.first.org/cvss/v4.0/user-guide
...
type CVSS struct {
	...
	AttackVector CVSS_AttackVector `protobuf:"varint,4,opt,name=attack_vector,json=attackVector,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_AttackVector" json:"attack_vector,omitempty"`
	// Attack Complexity (AC). Defined in CVSS v2, v3, v4.
	AttackComplexity CVSS_AttackComplexity `protobuf:"varint,5,opt,name=attack_complexity,json=attackComplexity,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_AttackComplexity" json:"attack_complexity,omitempty"`
	// Authentication (Au). Defined in CVSS v2.
	Authentication CVSS_Authentication `protobuf:"varint,6,opt,name=authentication,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_Authentication" json:"authentication,omitempty"`
	// Privileges Required (PR). Defined in CVSS v3, v4.
	PrivilegesRequired CVSS_PrivilegesRequired `protobuf:"varint,7,opt,name=privileges_required,json=privilegesRequired,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_PrivilegesRequired" json:"privileges_required,omitempty"`
	// User Interaction (UI). Defined in CVSS v3, v4.
	UserInteraction CVSS_UserInteraction `protobuf:"varint,8,opt,name=user_interaction,json=userInteraction,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_UserInteraction" json:"user_interaction,omitempty"`
	// Scope (S). Defined in CVSS v3.
	Scope CVSS_Scope `protobuf:"varint,9,opt,name=scope,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_Scope" json:"scope,omitempty"`
	// Confidentiality Impact (C). Defined in CVSS v2, v3.
	ConfidentialityImpact CVSS_Impact `protobuf:"varint,10,opt,name=confidentiality_impact,json=confidentialityImpact,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_Impact" json:"confidentiality_impact,omitempty"`
	// Integrity Impact (I). Defined in CVSS v2, v3.
	IntegrityImpact CVSS_Impact `protobuf:"varint,11,opt,name=integrity_impact,json=integrityImpact,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_Impact" json:"integrity_impact,omitempty"`
	// Availability Impact (A). Defined in CVSS v2, v3.
	AvailabilityImpact CVSS_Impact `protobuf:"varint,12,opt,name=availability_impact,json=availabilityImpact,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_Impact" json:"availability_impact,omitempty"`
	// Attack Requirements (AT). Defined in CVSS v4.
	AttackRequirements CVSS_AttackRequirements `protobuf:"varint,13,opt,name=attack_requirements,json=attackRequirements,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_AttackRequirements" json:"attack_requirements,omitempty"`
	// Vulnerable System Confidentiality Impact (VC). Defined in CVSS v4.
	VulnerableSystemConfidentialityImpact CVSS_Impact `protobuf:"varint,14,opt,name=vulnerable_system_confidentiality_impact,json=vulnerableSystemConfidentialityImpact,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_Impact" json:"vulnerable_system_confidentiality_impact,omitempty"`
	// Vulnerable System Integrity Impact (VI). Defined in CVSS v4.
	VulnerableSystemIntegrityImpact CVSS_Impact `protobuf:"varint,15,opt,name=vulnerable_system_integrity_impact,json=vulnerableSystemIntegrityImpact,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_Impact" json:"vulnerable_system_integrity_impact,omitempty"`
	// Vulnerable System Availability Impact (VA). Defined in CVSS v4.
	VulnerableSystemAvailabilityImpact CVSS_Impact `protobuf:"varint,16,opt,name=vulnerable_system_availability_impact,json=vulnerableSystemAvailabilityImpact,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_Impact" json:"vulnerable_system_availability_impact,omitempty"`
	// Subsequent System Confidentiality Impact (SC). Defined in CVSS v4.
	SubsequentSystemConfidentialityImpact CVSS_Impact `protobuf:"varint,17,opt,name=subsequent_system_confidentiality_impact,json=subsequentSystemConfidentialityImpact,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_Impact" json:"subsequent_system_confidentiality_impact,omitempty"`
	// Subsequent System Integrity Impact (SI). Defined in CVSS v4.
	SubsequentSystemIntegrityImpact CVSS_Impact `protobuf:"varint,18,opt,name=subsequent_system_integrity_impact,json=subsequentSystemIntegrityImpact,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_Impact" json:"subsequent_system_integrity_impact,omitempty"`
	// Subsequent System Availability Impact (SA). Defined in CVSS v4.
	SubsequentSystemAvailabilityImpact CVSS_Impact `protobuf:"varint,19,opt,name=subsequent_system_availability_impact,json=subsequentSystemAvailabilityImpact,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_Impact" json:"subsequent_system_availability_impact,omitempty"`
	// Exploit Maturity (E). Defined in CVSS v4.
	ExploitMaturity CVSS_ExploitMaturity `protobuf:"varint,20,opt,name=exploit_maturity,json=exploitMaturity,proto3,enum=grafeas.v1beta1.vulnerability.CVSS_ExploitMaturity" json:"exploit_maturity,omitempty"`
}
...
var file_cvss_proto_rawDesc = []byte{
	...
	0x6c, 0x6e, 0x65, 0x72, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x22, 0xd5, 0x18, 0x0a, 0x04,
	...
	0x12, 0x67, 0x0a, 0x13, 0x61, 0x74, 0x74, 0x61, 0x63, 0x6b, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x69,
	0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x36, 0x2e,
	...
	,
	...
	0x43, 0x56, 0x53, 0x53, 0x2e, 0x45, 0x78, 0x70, 0x6c, 0x6f, 0x69, 0x74, 0x4d, 0x61, 0x74, 0x75,
	0x72, 0x69, 0x74, 0x79, 0x52, 0x0f, 0x65, 0x78, 0x70, 0x6c, 0x6f, 0x69, 0x74, 0x4d, 0x61, 0x74,
	0x75, 0x72, 0x69, 0x74, 0x79, 0x22, 0x99, 0x01, 0x0a, 0x0c, 0x41, 0x74, 0x74, 0x61, 0x63, 0x6b,
	...
	0x04, 0x22, 0x8a, 0x01, 0x0a, 0x10, 0x41, 0x74, 0x74, 0x61, 0x63, 0x6b, 0x43, 0x6f, 0x6d, 0x70,
	...
	0x12, 0x1c, 0x0a, 0x18, 0x41, 0x54, 0x54, 0x41, 0x43, 0x4b, 0x5f, 0x43, 0x4f, 0x4d, 0x50, 0x4c,
	0x45, 0x58, 0x49, 0x54, 0x59, 0x5f, 0x4d, 0x45, 0x44, 0x49, 0x55, 0x4d, 0x10, 0x03, 0x22, 0x81,
	...
	0x00, 0x12, 0x1b, 0x0a, 0x17, 0x41, 0x55, 0x54, 0x48, 0x45, 0x4e, 0x54, 0x49, 0x43, 0x41, 0x54,
	0x49, 0x4f, 0x4e, 0x5f, 0x4d, 0x55, 0x4c, 0x54, 0x49, 0x50, 0x4c, 0x45, 0x10, 0x01, 0x12, 0x19,
	0x0a, 0x15, 0x41, 0x55, 0x54, 0x48, 0x45, 0x4e, 0x54, 0x49, 0x43, 0x41, 0x54, 0x49, 0x4f, 0x4e,
	0x5f, 0x53, 0x49, 0x4e, 0x47, 0x4c, 0x45, 0x10, 0x02, 0x12, 0x17, 0x0a, 0x13, 0x41, 0x55, 0x54,
	0x48, 0x45, 0x4e, 0x54, 0x49, 0x43, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x4e, 0x4f, 0x4e, 0x45,
	0x10, 0x03, 0x22, 0x92, 0x01, 0x0a, 0x12, 0x50, 0x72, 0x69, 0x76, 0x69, 0x6c, 0x65, 0x67, 0x65,
	0x73, 0x52, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x12, 0x23, 0x0a, 0x1f, 0x50, 0x52, 0x49,
	...
	0x55, 0x49, 0x52, 0x45, 0x44, 0x5f, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x01, 0x12, 0x1b, 0x0a, 0x17,
	0x50, 0x52, 0x49, 0x56, 0x49, 0x4c, 0x45, 0x47, 0x45, 0x53, 0x5f, 0x52, 0x45, 0x51, 0x55, 0x49,
	0x52, 0x45, 0x44, 0x5f, 0x4c, 0x4f, 0x57, 0x10, 0x02, 0x12, 0x1c, 0x0a, 0x18, 0x50, 0x52, 0x49,
	0x56, 0x49, 0x4c, 0x45, 0x47, 0x45, 0x53, 0x5f, 0x52, 0x45, 0x51, 0x55, 0x49, 0x52, 0x45, 0x44,
	0x5f, 0x48, 0x49, 0x47, 0x48, 0x10, 0x03, 0x22, 0xa8, 0x01, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72,
	...
	0x55, 0x49, 0x52, 0x45, 0x44, 0x10, 0x02, 0x12, 0x1c, 0x0a, 0x18, 0x55, 0x53, 0x45, 0x52, 0x5f,
	0x49, 0x4e, 0x54, 0x45, 0x52, 0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x50, 0x41, 0x53, 0x53,
	0x49, 0x56, 0x45, 0x10, 0x03, 0x12, 0x1b, 0x0a, 0x17, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x49, 0x4e,
	0x54, 0x45, 0x52, 0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x41, 0x43, 0x54, 0x49, 0x56, 0x45,
	0x10, 0x04, 0x22, 0x46, 0x0a, 0x05, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x12, 0x15, 0x0a, 0x11, 0x53,
	...
	0x5f, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x44, 0x10, 0x02, 0x22, 0x7b, 0x0a, 0x06, 0x49, 0x6d,
	...
	,
	...
	0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x63, 0x76, 0x73, 0x73, 0x5f, 0x67, 0x6f, 0x5f,
...
var file_cvss_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
...
var file_cvss_proto_goTypes = []interface{}{
	...
	(CVSS_AttackRequirements)(0), // 8: grafeas.v1beta1.vulnerability.CVSS.AttackRequirements
	(CVSS_ExploitMaturity)(0),    // 9: grafeas.v1beta1.vulnerability.CVSS.ExploitMaturity
	(*CVSS)(nil),                 // 10: grafeas.v1beta1.vulnerability.CVSS
}
var file_cvss_proto_depIdxs = []int32{
	...
	8,  // 9: grafeas.v1beta1.vulnerability.CVSS.attack_requirements:type_name -> grafeas.v1beta1.vulnerability.CVSS.AttackRequirements
	7,  // 10: grafeas.v1beta1.vulnerability.CVSS.vulnerable_system_confidentiality_impact:type_name -> grafeas.v1beta1.vulnerability.CVSS.Impact
	7,  // 11: grafeas.v1beta1.vulnerability.CVSS.vulnerable_system_integrity_impact:type_name -> grafeas.v1beta1.vulnerability.CVSS.Impact
	7,  // 12: grafeas.v1beta1.vulnerability.CVSS.vulnerable_system_availability_impact:type_name -> grafeas.v1beta1.vulnerability.CVSS.Impact
	7,  // 13: grafeas.v1beta1.vulnerability.CVSS.subsequent_system_confidentiality_impact:type_name -> grafeas.v1beta1.vulnerability.CVSS.Impact
	7,  // 14: grafeas.v1beta1.vulnerability.CVSS.subsequent_system_integrity_impact:type_name -> grafeas.v1beta1.vulnerability.CVSS.Impact
	7,  // 15: grafeas.v1beta1.vulnerability.CVSS.subsequent_system_availability_impact:type_name -> grafeas.v1beta1.vulnerability.CVSS.Impact
	9,  // 16: grafeas.v1beta1.vulnerability.CVSS.exploit_maturity:type_name -> grafeas.v1beta1.vulnerability.CVSS.ExploitMaturity
