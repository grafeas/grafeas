...
type ProducerSignature_KeyType int32

const (
	ProducerSignature_PKCS8_ED25519 ProducerSignature_KeyType = 0
)

// Enum value maps for ProducerSignature_KeyType.
var (
	ProducerSignature_KeyType_name = map[int32]string{
		0: "PKCS8_ED25519",
	}
	ProducerSignature_KeyType_value = map[string]int32{
		"PKCS8_ED25519": 0,
	}
)

func (x ProducerSignature_KeyType) Enum() *ProducerSignature_KeyType {
	p := new(ProducerSignature_KeyType)
	*p = x
	return p
}

func (x ProducerSignature_KeyType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProducerSignature_KeyType) Descriptor() protoreflect.EnumDescriptor {
	return file_common_proto_enumTypes[1].Descriptor()
}

func (ProducerSignature_KeyType) Type() protoreflect.EnumType {
	return &file_common_proto_enumTypes[1]
}

func (x ProducerSignature_KeyType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProducerSignature_KeyType.Descriptor instead.
func (ProducerSignature_KeyType) EnumDescriptor() ([]byte, []int) {
...
type ProducerSignature struct {
	...
	KeyType ProducerSignature_KeyType `protobuf:"varint,3,opt,name=key_type,json=keyType,proto3,enum=grafeas.v1beta1.ProducerSignature_KeyType" json:"key_type,omitempty"`
}

func (x *ProducerSignature) Reset() {
	*x = ProducerSignature{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProducerSignature) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProducerSignature) ProtoMessage() {}

func (x *ProducerSignature) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProducerSignature.ProtoReflect.Descriptor instead.
func (*ProducerSignature) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{2}
}

func (x *ProducerSignature) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (x *ProducerSignature) GetPublicKeyId() string {
	if x != nil {
		return x.PublicKeyId
	}
	return ""
...
func (x *ProducerSignature) GetKeyType() ProducerSignature_KeyType {
	if x != nil {
		return x.KeyType
	}
	return ProducerSignature_PKCS8_ED25519
}
...
var file_common_proto_rawDesc = []byte{
	...
	0x65, 0x79, 0x49, 0x64, 0x22, 0xba, 0x01, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x65,
	0x72, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x69,
	...
	,
	...
	0x0a, 0x0a, 0x06, 0x49, 0x4e, 0x54, 0x4f, 0x54, 0x4f, 0x10, 0x08, 0x12, 0x08, 0x0a, 0x04, 0x53,
	0x42, 0x4f, 0x4d, 0x10, 0x09, 0x12, 0x10, 0x0a, 0x0c, 0x53, 0x50, 0x44, 0x58, 0x5f, 0x50, 0x41,
	0x43, 0x4b, 0x41, 0x47, 0x45, 0x10, 0x0a, 0x12, 0x0d, 0x0a, 0x09, 0x53, 0x50, 0x44, 0x58, 0x5f,
	0x46, 0x49, 0x4c, 0x45, 0x10, 0x0b, 0x12, 0x15, 0x0a, 0x11, 0x53, 0x50, 0x44, 0x58, 0x5f, 0x52,
	0x45, 0x4c, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x53, 0x48, 0x49, 0x50, 0x10, 0x0c, 0x42, 0x56, 0x0a,
	0x12, 0x69, 0x6f, 0x2e, 0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73, 0x2e, 0x76, 0x31, 0x62, 0x65,
	0x74, 0x61, 0x31, 0x50, 0x01, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0xa2,
...
var file_common_proto_goTypes = []interface{}{
	...
	(ProducerSignature_KeyType)(0), // 1: grafeas.v1beta1.ProducerSignature.KeyType
	(*RelatedUrl)(nil),             // 2: grafeas.v1beta1.RelatedUrl
	(*Signature)(nil),              // 3: grafeas.v1beta1.Signature
	(*ProducerSignature)(nil),      // 4: grafeas.v1beta1.ProducerSignature
}
var file_common_proto_depIdxs = []int32{
	1, // 0: grafeas.v1beta1.ProducerSignature.key_type:type_name -> grafeas.v1beta1.ProducerSignature.KeyType
...
func file_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProducerSignature); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
