...
// The type of threat.
type VulnerabilityAssessmentNote_Assessment_Threat_ThreatType int32

const (
	// No threat type specified.
	VulnerabilityAssessmentNote_Assessment_Threat_THREAT_TYPE_UNSPECIFIED VulnerabilityAssessmentNote_Assessment_Threat_ThreatType = 0
	// IMPACT
	VulnerabilityAssessmentNote_Assessment_Threat_IMPACT VulnerabilityAssessmentNote_Assessment_Threat_ThreatType = 1
	// EXPLOIT_STATUS
	VulnerabilityAssessmentNote_Assessment_Threat_EXPLOIT_STATUS VulnerabilityAssessmentNote_Assessment_Threat_ThreatType = 2
)

// Enum value maps for VulnerabilityAssessmentNote_Assessment_Threat_ThreatType.
var (
	VulnerabilityAssessmentNote_Assessment_Threat_ThreatType_name = map[int32]string{
		0: "THREAT_TYPE_UNSPECIFIED",
		1: "IMPACT",
		2: "EXPLOIT_STATUS",
	}
	VulnerabilityAssessmentNote_Assessment_Threat_ThreatType_value = map[string]int32{
...
func (x VulnerabilityAssessmentNote_Assessment_Threat_ThreatType) Enum() *VulnerabilityAssessmentNote_Assessment_Threat_ThreatType {
	p := new(VulnerabilityAssessmentNote_Assessment_Threat_ThreatType)
	*p = x
	return p
}

func (x VulnerabilityAssessmentNote_Assessment_Threat_ThreatType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (VulnerabilityAssessmentNote_Assessment_Threat_ThreatType) Descriptor() protoreflect.EnumDescriptor {
	return file_vex_proto_enumTypes[1].Descriptor()
}

func (VulnerabilityAssessmentNote_Assessment_Threat_ThreatType) Type() protoreflect.EnumType {
	return &file_vex_proto_enumTypes[1]
}

func (x VulnerabilityAssessmentNote_Assessment_Threat_ThreatType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use VulnerabilityAssessmentNote_Assessment_Threat_ThreatType.Descriptor instead.
func (VulnerabilityAssessmentNote_Assessment_Threat_ThreatType) EnumDescriptor() ([]byte, []int) {
...
func (x *VulnerabilityAssessmentNote_Publisher) GetContext() string {
	if x != nil {
		return x.Context
	}
	return ""
...
func (x *VulnerabilityAssessmentNote_Product) GetGenericUri() *common_go_proto.RelatedUrl {
...
type VulnerabilityAssessmentNote_Product_GenericUri struct {
	...
	GenericUri *common_go_proto.RelatedUrl `protobuf:"bytes,3,opt,name=generic_uri,json=genericUri,proto3,oneof"`
}
...
type VulnerabilityAssessmentNote_Assessment struct {
	...
	// Contains information about this vulnerability, this will change with
	// time.
	Threats []*VulnerabilityAssessmentNote_Assessment_Threat `protobuf:"bytes,6,rep,name=threats,proto3" json:"threats,omitempty"`
...
func (x *VulnerabilityAssessmentNote_Assessment) GetThreats() []*VulnerabilityAssessmentNote_Assessment_Threat {
	if x != nil {
		return x.Threats
	}
	return nil
...
type VulnerabilityAssessmentNote_Assessment_Threat struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The type of threat.
	ThreatType VulnerabilityAssessmentNote_Assessment_Threat_ThreatType `protobuf:"varint,1,opt,name=threat_type,json=threatType,proto3,enum=grafeas.v1beta1.vex.VulnerabilityAssessmentNote_Assessment_Threat_ThreatType" json:"threat_type,omitempty"`
	// Represents a thorough human-readable discussion of the threat.
	Details string `protobuf:"bytes,2,opt,name=details,proto3" json:"details,omitempty"`
}

func (x *VulnerabilityAssessmentNote_Assessment_Threat) Reset() {
	*x = VulnerabilityAssessmentNote_Assessment_Threat{}
	if protoimpl.UnsafeEnabled {
...
func (x *VulnerabilityAssessmentNote_Assessment_Threat) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VulnerabilityAssessmentNote_Assessment_Threat) ProtoMessage() {}

func (x *VulnerabilityAssessmentNote_Assessment_Threat) ProtoReflect() protoreflect.Message {
	mi := &file_vex_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VulnerabilityAssessmentNote_Assessment_Threat.ProtoReflect.Descriptor instead.
func (*VulnerabilityAssessmentNote_Assessment_Threat) Descriptor() ([]byte, []int) {
	return file_vex_proto_rawDescGZIP(), []int{0, 2, 0}
}

func (x *VulnerabilityAssessmentNote_Assessment_Threat) GetThreatType() VulnerabilityAssessmentNote_Assessment_Threat_ThreatType {
	if x != nil {
		return x.ThreatType
	}
	return VulnerabilityAssessmentNote_Assessment_Threat_THREAT_TYPE_UNSPECIFIED
}

func (x *VulnerabilityAssessmentNote_Assessment_Threat) GetDetails() string {
	if x != nil {
		return x.Details
	}
	return ""
...
type VulnerabilityAssessmentNote_Assessment_Remediation struct {
	...
	RemediationTime *timestamp.Timestamp `protobuf:"bytes,2,opt,name=remediation_time,json=remediationTime,proto3" json:"remediation_time,omitempty"`
...
func (x *VulnerabilityAssessmentNote_Assessment_Remediation) GetRemediationTime() *timestamp.Timestamp {
	if x != nil {
		return x.RemediationTime
	}
	return nil
}
...
var file_vex_proto_rawDesc = []byte{
	...
	0x6f, 0x1a, 0x1a, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31,
	0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8b, 0x0f,
	0x0a, 0x1b, 0x56, 0x75, 0x6c, 0x6e, 0x65, 0x72, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x41,
	0x73, 0x73, 0x65, 0x73, 0x73, 0x6d, 0x65, 0x6e, 0x74, 0x4e, 0x6f, 0x74, 0x65, 0x12, 0x14, 0x0a,
	...
	0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x23, 0x0a, 0x0d, 0x6c,
	...
	0x12, 0x58, 0x0a, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x72, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73, 0x2e, 0x76, 0x31,
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x76, 0x65, 0x78, 0x2e, 0x56, 0x75, 0x6c, 0x6e, 0x65, 0x72,
	0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x41, 0x73, 0x73, 0x65, 0x73, 0x73, 0x6d, 0x65, 0x6e,
	0x74, 0x4e, 0x6f, 0x74, 0x65, 0x2e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x72, 0x52,
	0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x72, 0x12, 0x52, 0x0a, 0x07, 0x70, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x38, 0x2e, 0x67, 0x72,
	...
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x12, 0x5b,
	0x0a, 0x0a, 0x61, 0x73, 0x73, 0x65, 0x73, 0x73, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x3b, 0x2e, 0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73, 0x2e, 0x76, 0x31, 0x62,
	...
	,
	...
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3e, 0x0a, 0x0c, 0x72, 0x65, 0x6c,
	...
	0x31, 0x2e, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x55, 0x72, 0x6c, 0x52, 0x0b, 0x72, 0x65,
	0x6c, 0x61, 0x74, 0x65, 0x64, 0x55, 0x72, 0x69, 0x73, 0x12, 0x57, 0x0a, 0x05, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x41, 0x2e, 0x67, 0x72, 0x61, 0x66, 0x65,
	0x61, 0x73, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x76, 0x65, 0x78, 0x2e, 0x56,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x2e, 0x52, 0x65, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x0c, 0x72, 0x65, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0xdd, 0x01,
	0x0a, 0x06, 0x54, 0x68, 0x72, 0x65, 0x61, 0x74, 0x12, 0x6e, 0x0a, 0x0b, 0x74, 0x68, 0x72, 0x65,
	0x61, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x4d, 0x2e,
	0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e,
	0x76, 0x65, 0x78, 0x2e, 0x56, 0x75, 0x6c, 0x6e, 0x65, 0x72, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74,
	...
	,
	...
	0x53, 0x54, 0x49, 0x47, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x04, 0x42, 0x57, 0x0a, 0x16, 0x69,
	0x6f, 0x2e, 0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61,
	0x31, 0x2e, 0x76, 0x65, 0x78, 0x50, 0x01, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	...
	0x31, 0x2f, 0x76, 0x65, 0x78, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0xa2, 0x02,
...
var file_vex_proto_goTypes = []interface{}{
	...
	(VulnerabilityAssessmentNote_Assessment_Threat_ThreatType)(0),           // 1: grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.Threat.ThreatType
	...
	(*VulnerabilityAssessmentNote_Assessment_Threat)(nil),                   // 7: grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.Threat
...
var file_vex_proto_depIdxs = []int32{
	...
	9,  // 3: grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Product.generic_uri:type_name -> grafeas.v1beta1.RelatedUrl
	9,  // 4: grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.related_uris:type_name -> grafeas.v1beta1.RelatedUrl
	0,  // 5: grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.state:type_name -> grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.State
	7,  // 6: grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.threats:type_name -> grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.Threat
	8,  // 7: grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.remediations:type_name -> grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.Remediation
	1,  // 8: grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.Threat.threat_type:type_name -> grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.Threat.ThreatType
	2,  // 9: grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.Remediation.remediation_type:type_name -> grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.Remediation.RemediationType
	10, // 10: grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.Remediation.remediation_time:type_name -> google.protobuf.Timestamp
	9,  // 11: grafeas.v1beta1.vex.VulnerabilityAssessmentNote.Assessment.Remediation.remediation_uri:type_name -> grafeas.v1beta1.RelatedUrl
...
func file_vex_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vex_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VulnerabilityAssessmentNote_Assessment_Threat); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
