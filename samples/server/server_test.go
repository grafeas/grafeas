...
import (
	...
	"github.com/grafeas/grafeas/samples/server/storage"
	"github.com/grafeas/grafeas/samples/server/testing"
	"github.com/grafeas/grafeas/samples/server/v1alpha1"
...
func createOccurrence(o api.Occurrence, g Handler) (*api.Occurrence, error) {
	pID := "test-project"
...
func createNote(n api.Note, g Handler) error {
...
func createOperation(o api.Operation, g Handler, oID string) (*api.Operation, error) {
...
func TestListOccurrences(t *testing.T) {
	...
	got := api.ListOccurrencesResponse{}
	json.Unmarshal(w.Body.Bytes(), &got)
...
func TestListOperations(t *testing.T) {
	...
	got := api.ListOperationsResponse{}
	json.Unmarshal(w.Body.Bytes(), &got)
...
func TestListNoteOccurrences(t *testing.T) {
	...
	got := api.ListNoteOccurrencesResponse{}
	json.Unmarshal(w.Body.Bytes(), &got)
	if len(got.Occurrences) != 0 {
